/*! JsRender v1.0pre - (jsrender.js version: does not require jq): http://github.com/BorisMoore/jsrender */
/*
* Optimized version of jq Templates, fosr rendering to string, using 'codeless' markup.
*
* Copyright 2011, Boris Moore
* Released under the MIT License.
*/
window.JsViews || window.jq && jq.views || (function (window, undefined) {

    var $, _$, JsViews, viewsNs, tmplEncode, render, rTag, registerTags, registerHelpers, extend,
	FALSE = false, TRUE = true,
	jq = window.jq, document = window.document,
	htmlExpr = /^[^<]*(<[\w\W]+>)[^>]*$|\{\{\! /,
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // jq is loaded, so make $ the jq object
    $ = jq;
...
//    $.fn.template = function (name, context) {
...
//    };
    ...
    //        ////////////////////////////////////////////////////////////////////////////////////////////////
    //        // jq is not loaded. Make $ the JsViews object
    ...
    function View(context, path, parentView, data, template) {
        ...
        return {
            ...
            // If no jq, extend does not support chained copies - so limit to two parameters
            parent: parentView
        };
    }
    extend($, {
        ...
        template: function (name, tmpl) {
            ...
            // where tmpl is a template string, a script element or a jq instance wrapping a script element, etc.
    ...
    function try$(selector) {
        // If selector is valid, return jq object, otherwise return (invalid) selector string
        try {
            return $(selector);
        } catch (e) { }
        return selector;
