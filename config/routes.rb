Word::Application.routes.draw do
  ...
  # config/routes.rb
	scope "(:locale)", :locale => /en|es/ do
		...
		match "/games/play_/" => "games#play_"
		match "/games/swap_/" => "games#swap_"
		match "/games/skip_/" => "games#skip_"
		match "/games/chat_/" => "games#chat_"
		match "/games/create_/" => "games#create_"
		...
		match "/players/auth/" => "players#auth"
		match "/players/auth_with_payload/" => "players#auth_with_payload"
